#
#  Be sure to run `pod spec lint GodAnimation.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/daoinek/GodAnimation"
  ...
  spec.source       = { :git => "https://github.com/daoinek/GodAnimation.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "GodAnimation/**/*.{h,m,swift}"
